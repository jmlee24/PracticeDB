"""day4/complete/routes/categories.py — Day3 와 동일."""
from fastapi import APIRouter, Depends, HTTPException, Query
from sqlalchemy.orm import Session

from day4.complete.database import get_db
from day4.complete.models import Category
from day4.complete.schemas import CategoryCreate, CategoryResponse
