"""
상품 API 라우트 — Day 2 완성본
================================
CRUD 5개가 모두 완성된 상태입니다.
orders.py의 TODO를 풀 때 이 파일의 패턴을 참고하세요.
"""
from fastapi import APIRouter, Depends, HTTPException, Query
from sqlalchemy.orm import Session

from day3.database import get_db
from day3.models import Product, Category
from day3.schemas import ProductCreate, ProductResponse
